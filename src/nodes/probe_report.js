...
return [{ json: {
  STEP_0_REPORT: 'Read the actions_required list first. Everything else is evidence.',
  probed_at: store.probe.started_at,
  scrapingbee_requests_used: Object.keys(list).length + Object.keys(detail).length,
