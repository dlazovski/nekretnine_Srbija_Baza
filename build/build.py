...
main_nodes = [
    ...
    sheet("Write Page Checkpoint", [340, 640], "={{ $('Config').first().json.checkpoint_tab }}",
          ...
          notes="Persists the page number DURING pagination, so a run interrupted before the detail phase still has somewhere to resume from."),
...
main_conns = conn([
    ...
    ("More Pages?", 0, "Page Checkpoint Due?", 0),
    ("Page Checkpoint Due?", 0, "Build Page Checkpoint Row", 0),
    ("Page Checkpoint Due?", 1, "Fetch List Page", 0),
    ("Build Page Checkpoint Row", 0, "Write Page Checkpoint", 0),
    ("Write Page Checkpoint", 0, "Fetch List Page", 0),
